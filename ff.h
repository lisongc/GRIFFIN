...
Cplx B1(int it, int ot, int if1, int of1, double s, double cost, const inval &input, int AA, int AZ);

// one-loop box diagrams for k^2 = s, and GamZ = 0
...
// gamma-Z box contribution to R, where the deltaG term is add-back. (to cancel against matel)
