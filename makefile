...
# private options: sw2pdg, testdr2, testff
...
testdr2: testdr2.o deltar.o delrho.o classes.o B0.o li.o linex.o
...
testff: testff.o classes.o ff.o B0.o C0.o D0.o li.o
