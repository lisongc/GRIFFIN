...
public:
  ...
  double res3fff(void) const; //3-loop ew. corr. w/ three closed fermion loops
  double res3ffa2as(void) const; //3-loop qcd-ew. corr. w/ two closed fermion loops
  Cplx result(void) const
  {
    ...
    + res2fb() 
    + res2bb()
    	    + res2aas() + res3fff() + res3ffa2as() + drho3aas2() + drho3a3() + drho3a2as() + drho4aas3() 
          );
  }
...
public:
  ...
  double res2aas(void) const;  // 2-loop mixed ew-QCD corrections
  double res2aasnf(void) const;  // non-factorizable mixed ew-QCD corrections
  double res3fff(void) const; // 3-loop ew. cor. w/ three closed fermion loops 
  double res3ffa2as(void) const; //3-loop qcd-ew. corr. w/ two closed fermion loops
