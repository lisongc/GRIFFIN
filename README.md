...
One can download the released version 1.1.1 from [here](https://github.com/lisongc/GRIFFIN/releases/tag/v1.1.1)
...
After that, various test and demonstration programs can be compiled with
...
# Manual
The manual is available and can be found [here](https://github.com/lisongc/GRIFFIN_manual)
